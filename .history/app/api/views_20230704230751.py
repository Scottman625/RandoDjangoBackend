...
class MatchedNotChattedUsersView(APIView):
    def get(self, request, format=None):
        ...
        matches_with_messages = matches.annotate(msg_count=Count('messages')).filter(msg_count__gt=0)
        ...
        serializer = UserSerializer(users_matched_but_not_chatted, many=True)
