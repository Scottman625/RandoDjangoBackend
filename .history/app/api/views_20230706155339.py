...
class ChatRoomViewSet(viewsets.GenericViewSet,
    ...
    def get_queryset(self):
        ...
        for i in range(len(queryset)):
            ...
            queryset[i].career = other_side_user.career
...
class getChatRoomViewSet(APIView):
    ...
    def get(self,request):
        ...
        other_side_user = ChatroomUserShip.objects.filter(chatroom=chatroom&~Q(user=user)).first().user
        print(other_side_user)
        serializer = serializers.ChatRoomSerializer(chatroom)

        response_data = serializer.data
        response_data['other_side_user'] = other_side_user
        return Response(response_data)
