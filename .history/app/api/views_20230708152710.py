    ...
    def post(self, request):
        ...
        if user in chatroom_users:
            ...
            for i in range(len(messages)):
                ...
                message[i].should_show_time = message[i].should_show_sendTime
                message[i].other_side_image_url = other_side_user.imageUrl
                message[i].other_side_phone = other_side_user.phone
                message[i].message_is_mine = True
