...
from .models import User, ChatRoom, ChatroomMessage, ChatroomUserShip,UserMate
...
@admin.register(UserMate)
class UserMateAdmin(admin.ModelAdmin):
    list_display = ('id', 'update_at','maleUser','femaleUser' )
